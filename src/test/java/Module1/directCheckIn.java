...
public class directCheckIn {
	@Test
	public class directCheckin extends BaseAppium {
...
//		driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"LOGIN\"));"));
		...
		driver.findElement(AppiumBy.accessibilityId("Navigate up")).click();
		Thread.sleep(4000);
		driver.findElement(AppiumBy.xpath("//android.widget.ImageView[@content-desc=\"My Dealers\"]")).click();
		Thread.sleep(3000);
	//	new TouchAction<>(driver).tap(PointOption.point(790, 307)).perform();  //dealer
		driver.findElement(AppiumBy.accessibilityId("Check In")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		  ...
		  Thread.sleep(3000);
		  driver.findElement(AppiumBy.xpath("//android.widget.EditText[@index='4']")).sendKeys("1000"); 
		  Thread.sleep(3000); 
		  boolean canScrrollMore = (Boolean) ((JavascriptExecutor) driver).executeScript("mobile: scrollGesture", ImmutableMap.of(
				    "left", 100, "top", 100, "width", 200, "height", 200,
				    "direction", "down",
				    "percent", 3.0
				));
	...
	//	driver.findElement(AppiumBy.className("android.widget.Button")).click();
		...
		new TouchAction<>(driver).tap(PointOption.point(562, 1348)).perform();
         Thread.sleep(2000);
         driver.findElement(AppiumBy.accessibilityId("In Progress")).click();
         Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(AppiumBy.accessibilityId("SAVE NOTE")).click();
		Thread.sleep(8000);
		new TouchAction<>(driver).tap(PointOption.point(562, 1348)).perform();
         Thread.sleep(2000);
         driver.findElement(AppiumBy.accessibilityId("In Progress")).click();
